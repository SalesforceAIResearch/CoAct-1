...
class DockerProviderService:
            ...
            try:
                ...
                def run_container():
                    ...
                    try:
                        ...
                        if not wait_for_container_removal(self.client, container_name, timeout=CONTAINER_REMOVAL_TIMEOUT):
    ...
    @retry(**{
        'stop': stop_after_attempt(20),  # Reduce attempts to stop after ~100 seconds (20 attempts × 5 seconds)
